...
button.addEventListener("click", ()=>{
    ...
    const limiteur = 10;
    (0, _axiosDefault.default).get(`https://en.wikipedia.org/w/api.php?action=query&origin=*&format=json&generator=search&gsrnamespace=0&gsrlimit=${limiteur}&gsrsearch='${valeur}'`).then((response)=>{
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4rkIz","8lqZg"], "8lqZg", "parcelRequire440f")
