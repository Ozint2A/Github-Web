...
button.addEventListener("click", ()=>{
    fetch("https://nekos.best/api/v2/neko").then((response)=>response.json()).then((json)=>console.log(json.results[0].url));
});
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4rkIz","8lqZg"], "8lqZg", "parcelRequire372d")
