...
button.addEventListener("click", ()=>{
    ...
    if (valeur) {
        ...
        (0, _axiosDefault.default).get(imageUrl, {
            responseType: "blob"
        }).then((response)=>{
...
button2.addEventListener("click", ()=>{
    ...
    if (img) saveImage(img.src);
    else console.log("Aucune image \xe0 sauvegarder.");
});
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4rkIz","8lqZg"], "8lqZg", "parcelRequire81e0")
